<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterielAdd.aspx.cs" Inherits="SanalMuze.Dashboard" %>
...
<body>
    <form id="frmlMaterialAdd" runat="server">
        <div id="wrapper">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <asp:Button class="btn btn-default" ID="btn_save" OnClick="btn_save_Click" runat="server" Text="Save" />
